...
Check the [releases](https://github.com/droboports/coreutils/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/coreutils.git
cd coreutils
./build.sh
ls -la *.tgz
```
